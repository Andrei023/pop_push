...
public class QuickPopLogicTest {
    ...
    @Test
    public void GIVEN_quickPopIntegerMax_WHEN_emptyPop_THEN_noErrors() {
        underTest.pop();
    }

    @Test
    public void GIVEN_quickPopIntegerMax_WHEN_popFromSingleElementList_THEN_listIsEmpty() {
    ...
    @Test
    public void GIVEN_quickPopIntegerMax_WHEN_popDuplicate_THEN_noErrors() {
        underTest.push(this.getSort().parseElement("23"));
        underTest.push(this.getSort().parseElement("23"));
    ...
    @Test
    public void GIVEN_quickPopIntegerMax_WHEN_popFromMultipleElementList_THEN_maxIsPopped() {
        underTest.push(this.getSort().parseElement("23"));
    ...
    @Test
    public void GIVEN_quickPopStringAtoZ_WHEN_popFromMultipleElementList_THEN_maxIsPopped() {
