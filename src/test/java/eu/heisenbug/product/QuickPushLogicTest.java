...
class QuickPushLogicTest {

    AbstractOrderedList<Integer> integerProduct;

    @BeforeEach
    void init() {
        integerProduct = new QuickPushOrderedList<>(new IntegerMaximum());
    }

    @Test
    void GIVEN_quickPushIntegerMax_WHEN_emptyPop_THEN_noErrors() {
        integerProduct.pop();
        assertEquals("[]", getElements(integerProduct.getHead()));
    }

    @Test
    void GIVEN_quickPushIntegerMax_WHEN_popFromSingleElementList_THEN_listIsEmpty() {
    ...
    @Test
    void GIVEN_quickPushIntegerMax_WHEN_popDuplicate_THEN_noErrors() {
        integerProduct.push(23);
        integerProduct.push(23);
    ...
    @Test
    void GIVEN_quickPushIntegerMax_WHEN_popFromMultipleElementList_THEN_maxIsPopped() {
        integerProduct.push(23);
    ...
    @Test
    void GIVEN_quickPushStringAtoZ_WHEN_popFromMultipleElementList_THEN_maxIsPopped() {
        AbstractOrderedList<String> stringProduct = new QuickPushOrderedList<>(new StringAtoZ());
